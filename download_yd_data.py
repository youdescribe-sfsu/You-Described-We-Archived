...
def downloadAudioDescriptions(inputFile, audioDescDir):
    ...
    for col, row in enumerate(inputRows):
        ...
        if doc.status_code >=200 and doc.status_code < 300:
...
def main():
    ...
    downloadAudioDescriptions(opt.inputFile, opt.audioDescDir)
